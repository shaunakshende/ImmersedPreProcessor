...
S = sf.background_with_uniform_refinement(C3, C4, 0.305+1.0*padding, np.array([21, 21, 21]),O, np.array([0.4, 0.6]), np.array([0.4, 0.6]), np.array([0.0, 0.16]), 40);
#print(S.knots)
...
G1 = sf.translate(G1, 0.305/2.0-0.0051+padding/2.0, 0.305/2.0-0.0051+padding/2.0, 0.075-(0.004651320879015)/2.0) # 152 mm standoff distance
