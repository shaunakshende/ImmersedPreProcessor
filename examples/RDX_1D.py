...
C3=line(p0=(0.00,0.00,0), p1=(0.25,0.00,0))
C4=line(p0=(0.00,0.1,0), p1=(0.25,0.1,0))
...
S=sf.cent_stretch_bg(C3, C4, 0, np.array([25, 1, 0]), np.array([1.1,1.1,1.0]), np.array([1.0,1.0,1]), n=1)
...
G=ms.generate_unif_foreground(O, np.array([0.005415, 0.1, 0.0]), np.array([4, 4, 1]))
