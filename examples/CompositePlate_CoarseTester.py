...
S = ms.generate_unif_background(C3, C4, 0.305+1.0*padding, np.array([21, 21, 21]));
...
G1 = ms.generate_unif_foreground(O, np.array([0.0051*2.0, 0.0051*2.0, 0.004651320879015]), np.array([11, 11, 3]), 1)
G1 = sf.translate(G1, 0.305/2.0-0.0051+padding/2.0, 0.305/2.0-0.0051+padding/2.0, 0.150-(0.004651320879015-0.5/15.0)/2.0) # 152 mm standoff distance
